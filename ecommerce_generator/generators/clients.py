...
Uwaga:
  - `_segment` jest polem wewnętrznym dla generatorów adresów i zamówień.
  - Nie zapisuj `_segment` do finalnej tabeli clients.
"""
...
def _build_email(first_name: str, last_name: str, client_id: int) -> str:
    """Buduje prosty, realistyczny i unikalny e-mail."""
...
def generate_clients(n: int) -> list[dict]:
    ...
    for client_id in range(1, n + 1):
        ...
        clients.append({
            ...
            "_segment": segment,  # wewnętrzne tylko dla generatorów
        })
